...
ActiveRecord::Schema.define(version: 2019_08_20_233809) do
  ...
  create_table "cashbooks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "title"
    t.integer "type"
    t.decimal "opening_value", precision: 10
  ...
  create_table "transactions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.date "date"
    t.integer "code"
    t.decimal "amount_value", precision: 10
    t.integer "amount_flag"
    t.decimal "balance_value", precision: 10
